...
add_action('init', function() {
  ...
  //wp_enqueue_script('comments_evolved_tabs_js', COMMENTS_EVOLVED_URL . '/assets/javascript/plugin.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-tabs' ), COMMENTS_EVOLVED_VERSION);
});
